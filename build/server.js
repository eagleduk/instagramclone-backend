...
function _startServer() {
  _startServer = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5() {
    var app, httpServer, wsServer, getDynamicContext, schema, serverCleanup, server;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          case 0:
            ...
            getDynamicContext = /*#__PURE__*/function () {
              var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(ctx, msg, args) {
                var loggedInUser;
                  ...
                  while (1) {
                    switch (_context.prev = _context.next) {
                      case 0:
                        ...
                        _context.next = 3;
                        return (0, _users.logginUser)(ctx.connectionParams.token);
              ...
              return function getDynamicContext(_x, _x2, _x3) {
            ...
            serverCleanup = (0, _ws2.useServer)({
              ...
              context: function context(ctx, msg, args) {
            ...
            server = new _apolloServerExpress.ApolloServer({
              ...
              cache: "bounded",
              context: function () {
                var _context2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(_ref2) {
                  var req;
                  return _regeneratorRuntime().wrap(function _callee2$(_context3) {
                    while (1) {
                      switch (_context3.prev = _context3.next) {
                        case 0:
                          req = _ref2.req;
                          _context3.t0 = req.headers.token;
                          _context3.next = 4;
                          return (0, _users.logginUser)(req.headers.token);

                        case 4:
                          _context3.t1 = _context3.sent;
                          return _context3.abrupt("return", {
                            token: _context3.t0,
                            loggedInUser: _context3.t1
                          });
